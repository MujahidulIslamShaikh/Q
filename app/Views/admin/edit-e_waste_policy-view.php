        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/edit-EwastePolicy/'.$e_waste['id']) ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label">E-waste Policy</label>
                                            <textarea class="form-control" rows="5" name="policy" id="policy"><?= $e_waste['policy'] ?></textarea>
