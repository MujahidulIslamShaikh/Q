        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/add-service') ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger"><?= validation_show_error('model_id') ?></small>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <table class="table table-center table-hover" id="serviceTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" name="main_price[]" class="form-control" value="" oninput="calculatePercentageOff(event)" required>
                                                    </td>
                                                    <td>
                                                        <input type="number" name="discounted_price[]" class="form-control" oninput="calculatePercentageOff(event)" required>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="percent_off[]" class="form-control" readonly>
                                                    </td>
                                                    <td>
...
<script>
    ...
    $(document).ready(function() {
        $('#brand_id').change(function() {
            ...
            if (brand_id) {
                $.ajax({
                    url: "<?= base_url('/admin/get-model/') ?>" + brand_id,
                    type: 'GET',
                    dataType: 'json',
