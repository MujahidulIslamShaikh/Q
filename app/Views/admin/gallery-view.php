        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('admin/add-gallery') ?>" class="btn btn-primary me-1">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        <?php $a=1; foreach($gallery as $gallery): ?>
                                            <tr>
                                                <td><?= $a++; ?></td>
                                                <td><img src="<?= base_url('public/uploads/'.$gallery['image']) ?>" alt="Icon" style="width: 100px; height: 100px;"></td>
                                                <td><?= $gallery['title'] ?></td>
                                                <td><?= date('d-m-Y', strtotime($gallery['created_at'])) ?></td>
                                                <td class="text-right">
                                                    <a href="javascript:void(0);" onclick="confirmDelete(<?= $gallery['id'] ?>)" class="btn btn-sm btn-white text-danger me-2">
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('/admin/delete-gallery/') ?>" + id;
                }
            });
        }
    </script>
