        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/Issues') ?>">Manage Common Issues</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/edit-issue/'.$issue['id']) ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <img src="<?= base_url('public/uploads/'.$issue['image']) ?>" alt="icon" style="width: 100px; height: 100px;">
                                    </div>
