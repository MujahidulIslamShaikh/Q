    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Edit Warranty Policy</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/WarrantyPolicy') ?>">Manage Warranty Policy</a></li>
                            <li class="breadcrumb-item active">Edit Warranty Policy</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/edit-warranty-policy/'.$policy['id']) ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label">Warranty Policy</label>
                                            <textarea class="form-control" rows="5" name="warranty_policy" id="warranty_policy"><?= $policy['warranty_policy'] ?></textarea>
