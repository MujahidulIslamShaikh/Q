        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/Blog') ?>">Manage Blogs</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/edit-blog/'.$blog['id'] ) ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control" value="<?= set_value('title', $blog['title']) ?>">
                                    ...
                                    <div class="col-md-2">
                                        <img src="<?= base_url('public/uploads/'.$blog['image']) ?>" alt="icon" style="width: 150px; height: 150px;">
                                    </div>
