        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Manage Videos</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('admin/add-video') ?>" class="btn btn-primary me-1">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        <?php $a=1; foreach($videos as $video): ?>
                                            <tr>
                                                <td><?= $a++; ?></td>
                                                <td><?= substr($video['title'], 0, 30) . '...'; ?></td>
                                                <td><img src="<?= base_url('public/uploads/'.$video['image']) ?>" alt="Icon" style="width: 50px; height: 50px;"></td>
                                                <td><?= date('d-m-Y', strtotime($video['created_at'])) ?></td>
                                                <td class="text-right">
                                                    <a href="javascript:void(0);" onclick="confirmDelete(<?= $video['id'] ?>)" class="btn btn-sm btn-white text-danger me-2">
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('/admin/delete-video/') ?>" + id;
                }
            });
        }
    </script>
