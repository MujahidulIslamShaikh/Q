        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('admin/add-testimonial') ?>" class="btn btn-primary me-1">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        <?php $a=1; foreach($testimonials as $testimonial): ?>
                                        <tr>
                                            <td><?= $a++; ?></td>
                                            <td> <?= $testimonial['user_name'] ?> </td>
                                            <td> <?= substr($testimonial['description'], 0, 30) . '...'; ?> </td>
                                            <td><?= date('d-m-Y', strtotime($testimonial['created_at'])) ?></td>
                                            <td class="text-right">
                                                <a href="javascript:void(0);" onclick="confirmDelete(<?= $testimonial['id'] ?>)" class="btn btn-sm btn-white text-danger me-2">
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('/admin/delete-testimonial/') ?>" + id;
                }
            });
        }
    </script>
