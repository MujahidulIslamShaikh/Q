        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Manage Email</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('admin/add-email') ?>" class="btn btn-primary me-1">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        <?php $a=1; foreach($email as $email): ?>
                                        <tr>
                                            <td><?= $a++; ?></td>
                                            <td> <?= $email['email'] ?> </td>
                                            <td><?= date('d-m-Y', strtotime($email['created_at'])) ?></td>
                                            <td class="text-right">
                                                <a href="<?= base_url('admin/edit-email/'.$email['id']) ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a>
                                                <a href="javascript:void(0);" onclick="confirmDelete(<?= $email['id'] ?>)" class="btn btn-sm btn-white text-danger me-2">
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('/admin/delete-email/') ?>" + id;
                }
            });
        }
    </script>
