        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('admin/add-faq') ?>" class="btn btn-primary me-1">
                                ...
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?= base_url('admin/edit-faq/'.$faq['id']) ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> Edit</a>
                                                <a href="javascript:void(0);" onclick="confirmDelete(<?= $faq['id'] ?>)" class="btn btn-sm btn-white text-danger me-2">
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?= base_url('/admin/delete-faq/') ?>" + id;
                }
            });
        }
    </script>
